...
plot_double_time <- function(data, ylog = F){
  the_labs <- labs(x = 'Date',
                   ...
                   subtitle = 'Basic log-linear model assuming no change in growth trajectory since first day at >5 deaths')
  long <- data %>%
...
data <- make_double_time(n_deaths_start = 130)
plot_double_time(data)
