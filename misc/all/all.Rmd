...
make_double_time <- function(the_country = 'Spain',
                             n_deaths_start = 5,
                             time_ahead = 5){
   sub_data <-df_country %>% filter(country == the_country)
  # Only calculate on countries with n_cases_start or greater cases,
  # starting at the first day at n_cases_start or greater
...
data <- make_double_time(n_deaths_start = 100)
data
plot_double_time(data, ylog = F) +
  labs(subtitle = 'Basic log-linear model assuming no change in growth trajectory since first day at >100 deaths')
