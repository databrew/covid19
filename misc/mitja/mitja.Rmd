...
ggsave('high_quality/points_death_absolute.pdf')
```
...
make_map(var = 'deaths',
  ...
  labs(title = 'Number of deaths',
       caption = '@joethebrew')
ggsave('high_quality/polygons_death_absolute.pdf')
...
make_map(var = 'deaths', pop = TRUE, points = T) +
  labs(title = 'Number of deaths per 100,000',
       caption = '@joethebrew')
ggsave('high_quality/points_death_adjusted.pdf')
...
make_map(var = 'deaths', pop = TRUE, points = F, line_color = 'darkgrey') +
  labs(title = 'Number of deaths per 100,000',
       caption = '@joethebrew')
ggsave('high_quality/polygons_death_adjusted.pdf')
...
make_dot_map(var = 'deaths', point_size = 0.15) +
  labs(title = 'COVID-19 deaths: 1 point = 1 death\nImportant: points are random within each CCAA; do not reflect exact location',
       caption = '@joethebrew')
ggsave('high_quality/point_per_death.pdf')
...
make_map(var = 'confirmed_cases',
  ...
  labs(title = 'Number of confirmed cases',
       caption = '@joethebrew')
ggsave('high_quality/points_case_absolute.pdf')
...
make_map(var = 'confirmed_cases',
  ...
  labs(title = 'Number of confirmed cases',
       caption = '@joethebrew')
ggsave('high_quality/polygon_case_absolute.pdf')
...
make_map(var = 'confirmed_cases', pop = TRUE, points = T) +
  labs(title = 'Number of confirmed cases per 100,000',
       caption = '@joethebrew')
ggsave('high_quality/points_case_adjusted.pdf')
...
make_map(var = 'confirmed_cases', pop = TRUE, points = F,
  ...
  labs(title = 'Number of confirmed cases per 100,000',
       caption = '@joethebrew')
ggsave('high_quality/polygons_case_adjusted.pdf')
...
make_dot_map(var = 'confirmed_cases',
  ...
  labs(title = 'COVID-19 cases: 1 point = 10 cases\nImportant: points are random within each CCAA; do not reflect exact location',
       caption = '@joethebrew')
ggsave('high_quality/point_per_10_cases.pdf')
