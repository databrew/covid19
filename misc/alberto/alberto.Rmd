...
aa <- ggplot(data = pd,
  ...
  scale_y_continuous(sec.axis = sec_axis(trans = ~ . * transformer,
                                         name = 'Daily cases')) +
  scale_linetype_manual(name = 'Confirmed COVID-19 cases', values = c(1,2)) +
  theme(legend.position = 'top',
        legend.title = element_text(size = text_size * 1.05, hjust = 0.5),
...
bb <- ggplot(data = pd,
  ...
  scale_y_continuous(sec.axis = sec_axis(trans = ~ . * transformer,
                                         name = 'Daily deaths')) +
  scale_linetype_manual(name = 'Confirmed COVID-19 deaths', values = c(1,2)) +
  theme(legend.position = 'top',
        legend.title = element_text(size = text_size * 1.05, hjust = 0.5),
        legend.text = element_text(size = text_size * 0.98,
                                   hjust = 0.5)) +
...
cc <- ggplot(data = pd,
  ...
  scale_linetype_manual(name = 'COVID-19 ICU admissions', values = c(1,2)) +
  theme(legend.position = 'top',
        legend.title = element_text(size = text_size * 1.05, hjust = 0.5),
        legend.text = element_text(size = text_size * 0.98,
                                   hjust = 0.5)) +
...
dd <- ggplot(data = pd,
  ...
  scale_linetype_manual(name = 'Confirmed COVID-19 cases per 100,000', values = c(1,2)) +
  theme(legend.position = 'top',
        legend.title = element_text(size = text_size * 1.05, hjust = 0.5),
        legend.text = element_text(size = text_size * 0.98,
                                   hjust = 0.5)) +
...
ee <- ggplot(data = pd,
  ...
  scale_linetype_manual(name = 'Confirmed COVID-19 deaths per 100,000', values = c(1,2)) +
  theme(legend.position = 'top',
        legend.title = element_text(size = text_size * 1.05, hjust = 0.5),
        legend.text = element_text(size = text_size * 0.98,
                                   hjust = 0.5)) +
...
ff <- ggplot(data = pd,
  ...
  scale_linetype_manual(name = 'COVID-19 ICU admissions per 100,000', values = c(1,2)) +
  theme(legend.position = 'top',
        legend.title = element_text(size = text_size * 1.05, hjust = 0.5),
        legend.text = element_text(size = text_size * 0.98,
                                   hjust = 0.5)) +
