...
ccii <- ggplot(data = pd,
  ...
  theme_simple() +
  geom_line() +
  labs(x = 'Days since first ICU admission',
       y = 'Cumulative ICU admissions',
       title = 'E',
       caption = paste0('Data as of ', max_date)) +
  theme(axis.title = element_text(size = text_size),
...
ddii <- ggplot(data = pd,
  ...
  theme_simple() +
  geom_line() +
  labs(x = 'Days since first day at >1 cumulative case per 100,000',
       y = 'Cumulative cases per 100,000',
       title = 'B',
       caption = paste0('Data as of ',max_date)) +
  theme(axis.title = element_text(size = text_size),
...
eeii <- ggplot(data = pd,
  ...
  theme_simple() +
  geom_line() +
  labs(x = 'Days since first day at >1 daily death per 100,000',
       y = 'Cumulative deaths per 100,000',
       title = 'D',
       caption = paste0('Data as of ', max_date)) +
  theme(axis.title = element_text(size = text_size),
...
ffii <- ggplot(data = pd,
  ...
  theme_simple() +
  geom_line() +
  labs(x = 'Days since first day at >1 ICU admission per 100,000',
       y = 'Cumulative ICU admissions per 100,000',
       title = 'F',
       caption = paste0('Data as of ', max_date)) +
  theme(axis.title = element_text(size = text_size),
